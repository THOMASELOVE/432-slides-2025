...
format:
  revealjs: 
    ...
    footer: "432 Class 01 | 2025-01-14 | <https://thomaselove.github.io/432-2025/>"
---
...
- These Slides for Class 01 are linked at the Class 01 README. 
  ...
  - We also provide the Quarto code I used to build the slides, and a Word version which some people prefer for taking notes.
...
- We provide a Quarto template for Lab 1 (due Wednesday 2025-01-22 at Noon) which should ease your transition a bit.
