...
## A briefer summary^[This table was hand-crafted by Dr. Love.] {.smaller}
...
$$
\hat{\mbox{ladder}} = -5.283 + 1.107 \mbox{ log_gdp} + \\
4.445 \mbox{ (ftemp_c = warm)} - 0.425 \mbox{ log_gdp } \times \mbox{ (ftemp_c = warm)}
$$
...
- Using the `lm()` fit, and a prediction interval for one country...

```{r}
#| echo: true
predict(fit1_lm, newdata = usadat, interval = "prediction", level = 0.90)
```
...
#| echo: true
predict(fit1_lm, newdata = usadat, interval = "prediction", level = 0.90)
predict(fit2_lm, newdata = usadat, interval = "prediction", level = 0.90)
predict(fit3_lm, newdata = usadat, interval = "prediction", level = 0.90)
predict(fit4_lm, newdata = usadat, interval = "prediction", level = 0.90)
predict(fit5_lm, newdata = usadat, interval = "prediction", level = 0.90)
```
